...
\texttt{ucasthesis}宏包可以在目前大多数的\TeX{}系统中使用，例如C\TeX{}、MiK\TeX{}、\TeX{}Live。Windows使用者可安装C\TeX{}、MiK\TeX{}、\TeX{}Live中的一项。 \texttt{ucasthesis}宏包通过\texttt{ctexbook}宏包来获得中文支持。
