...
\begin{enumerate}
  ...
  \item 若编译出现关于 “adobefonts” 的错误，则是由于系统缺乏 “adobe” 的相应中文字体，请在adobe 官网（\url{http://www.adobe.com/support/downloads/product.jsp?product=10&platform=Windows}） 或是其他公共网站上搜索并下载如下四种中文字体文件：
      \begin{enumerate}
