...
* `2018-03-08` 模板样式进行了修改，请查看下面的修改描述，以决定是否需要更新。

## 更新记录

* `2018-03-08` 矫正格式上的由 will0n 和赵永明提出的一些细节问题，根据 tangjie1992 的建议配置算法环境，修改的文件为：ucasthesis.cls, ucasthesis.cfg, artratex.sty, 模板使用说明.pdf。
