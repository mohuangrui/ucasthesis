...
* `2018-03-12` 模板样式进行了修改，请查看下面的修改描述，以决定是否需要更新。

## 更新记录

* `2018-03-12` 进一步完善说明文档，提供目录区域独立行距设置，将正文默认行距改为易于阅读的1.5（可根据个人所用的官方规则需要轻松设定），修复修改行距后章节标题位置轻微上下浮动1-2毫米的问题，更新参考文献样式文件，修改的文件为：Thesis.tex, ucasthesis.cls, ucasthesis.cfg, gbt7714-xxx.bst, 模板使用说明.pdf。
