# `ucasthesis` 国科大学位论文 LaTeX 模板 [最新样式-2023版]
...
* 由于每年的格式变动，**可能**需要对模板进行部分修改，因此创建本仓库，主要目的为个人使用，仅供参考
...
* `2024-02-29` 更新至2023年格式，细节包括行距修改，附录相关命名修改，图表公式显示格式修改，图表目录合并及目录项修改等。基本保证与官方样稿格式一致且尽量维持最小改动。**目前对于附录中的图表在对应的目录显示仍有问题，需注意**
